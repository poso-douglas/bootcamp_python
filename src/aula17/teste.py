...
try:  # Usando a sessão corretamente com o gerenciador de contexto
...
# # Supondo que engine já foi definido anteriormente e os modelos Produto
# e Fornecedor foram definidos conforme o exemplo anterior.
